...
class SignUpForm extends Component {
    ...
    onSubmit(values) {
        ...
        API.SignUp(values)
            .then((res) => {
                console.log("admin signup----->" + JSON.stringify(res));
                ...
                if(res.message){
                    ...
                    alert(`Please verify your email: ${values.email} for verification link`)
            ...
            <div className="panel col-md-5">
                <div className="sub-panel">
                    <form onSubmit={handleSubmit(this.onSubmit.bind(this))}>
                        ...
                        <label htmlFor="PasswordBox" className="font-family-roboto">Confirm</label>
                        <Field name="confirm" type="password" maxLength="40" id="ConfirmBox"
                               component={this.renderField}/>
