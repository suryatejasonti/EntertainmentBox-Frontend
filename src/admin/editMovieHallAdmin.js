...
import {addMovies, getAllMovieHalls,saveMovieHallEdits} from '../actions/pranithActions'
...
(connect(mapStateToProps, {addMovies, getAllMovieHalls,saveMovieHallEdits})(EditMovieHallAdmin));
